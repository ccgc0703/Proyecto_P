...
let UsersController = class UsersController {
    ...
    async create(createUserDto, req) {
        var _a;
        const user = await this.usersService.create(createUserDto, req.user.id, req.ip, (_a = req.headers) === null || _a === void 0 ? void 0 : _a['user-agent']);
        return {
            success: true,
    ...
    async update(id, updateUserDto, req) {
        var _a;
        const user = await this.usersService.updateUser(id, updateUserDto, req.user.id, req.ip, (_a = req.headers) === null || _a === void 0 ? void 0 : _a['user-agent']);
        return {
            success: true,
    ...
    async remove(id, req) {
        var _a;
        await this.usersService.remove(id, req.user.id, req.ip, (_a = req.headers) === null || _a === void 0 ? void 0 : _a['user-agent']);
        return {
            success: true,
