...
let RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        ...
        if (user.rol === constantes_1.ROLES.ADMIN)
            return true;
        ...
        if (rolesRestringidos.includes(user.rol)) {
            ...
            if (targetUnidadId && targetUnidadId !== user.unidadId) {
                throw new common_1.ForbiddenException('Aislamiento por Unidad: Solo puedes gestionar datos de tu propia unidad asignada');
            }
        }
        return true;
    }
